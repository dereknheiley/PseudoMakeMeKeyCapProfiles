...
//  BotWid,BotLen,TWDif,TLDif,  keyh,WSft,LSft,XSkew,  YSkew, ZSkew, WEx, LEx, CapR0i, CapR0f, CapR1i, CapR1f, CapREx, StemEx
    [17.16, 17.16,  6.5,  7.5, 12.75,   0,   0,    4,      0,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //0 R3
    [17.16, 17.16,  6.5,  7.5, 15.75,   0,   0,   -4,      0,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //1 R1
    [17.16, 17.16,  6.5,  7.5, 13.5 ,   0,   0,   -3,      0,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //2 R2
    [17.16, 17.16,  6.5,  7.5, 12.75,   0,   0,    4,      0,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //3 R3DD
    [17.16, 17.16,  6.5, 7.75, 13.75,   0, .45,  -13,      0,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //4 R4
    [17.16, 17.16,  6.5, 7.75, 17.0 ,   0,-.25,   20,      0,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //5 R5

    //left outer column curved in
    [17.16, 17.16,  6.5,  7.5, 16.25,-.75,   0,   -4,     -8,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //6  R1
    [17.16, 17.16,  6.5,  7.5, 14.0 ,-.75,   0,   -3,     -8,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //7  R2
    [17.16, 17.16,  6.5,  7.5, 13.5, -.75,   0,    4,     -8,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //8  R3
    [17.16, 17.16,  6.5, 7.75, 14.25,-.75, .45,  -13,     -8,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //9  R4
    [17.16, 17.16,  6.5, 7.75, 17.0 ,-.75,-.25,   20,     -8,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //10 R5

    //right outer column curved in
    [17.16, 17.16,  6.5,  7.5, 16.25, .75,   0,   -4,      8,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //11 R1
    [17.16, 17.16,  6.5,  7.5, 14.0 , .75,   0,   -3,      8,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //12 R2
    [17.16, 17.16,  6.5,  7.5, 13.5,  .75,   0,    4,      8,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //13 R3
    [17.16, 17.16,  6.5, 7.75, 14.25, .75, .45,  -13,      8,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //14 R4
    [17.16, 17.16,  6.5, 7.75, 17.0 , .75,-.25,   20,      8,     0,   2,1.25,      1,      5,      1,    3.5,      2,      2], //15 R5
];
